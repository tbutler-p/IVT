...
class BaseTextSerializer(ABC):
    ...
    @abstractmethod
    def serialize(self, *, item: TextItem, doc_serializer: BaseDocSerializer, doc: DoclingDocument, **kwargs: Any) -> SerializationResult:
...
class BaseListSerializer(ABC):
    ...
    @abstractmethod
    def serialize(self, *, item: ListGroup, doc_serializer: BaseDocSerializer, doc: DoclingDocument, **kwargs: Any) -> SerializationResult:
        """Serializes the passed item."""
        ...
...
class BaseInlineSerializer(ABC):
    ...
    @abstractmethod
    def serialize(self, *, item: InlineGroup, doc_serializer: BaseDocSerializer, doc: DoclingDocument, **kwargs: Any) -> SerializationResult:
        """Serializes the passed item."""
        ...
...
class BaseDocSerializer(ABC):
    ...
    @abstractmethod
    def serialize(self, *, item: Optional[NodeItem] = ..., **kwargs: Any) -> SerializationResult:
    ...
    @abstractmethod
    def get_parts(self, item: Optional[NodeItem] = ..., **kwargs: Any) -> list[SerializationResult]:
