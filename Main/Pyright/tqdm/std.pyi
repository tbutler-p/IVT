...
from .utils import Comparable, envwrap
...
class tqdm(Comparable):
    ...
    @staticmethod
    def status_printer(file): # -> Callable[..., None]:
        """
    ...
    @classmethod
    @contextmanager
    def external_write_mode(cls, file=..., nolock=...): # -> Generator[None, Any, None]:
        """
    ...
    @classmethod
    def pandas(cls, **tqdm_kwargs): # -> None:
        """
    ...
    @property
    def format_dict(self): # -> defaultdict[str, int | Any | str | None] | dict[str, Any]:
        """Public API for read-only member access."""
        ...
    
    def display(self, msg=..., pos=...): # -> bool:
        """
    ...
    @classmethod
    @contextmanager
    def wrapattr(cls, stream, method, total=..., bytes=..., **tqdm_kwargs): # -> Generator[CallbackIOWrapper, Any, None]:
        """
