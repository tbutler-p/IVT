...
schematron_schema_valid_supported = ...
def stylesheet_params(**kwargs): # -> dict[Any, Any]:
...
class Schematron(_etree._Validator):
    ...
    _compile = ...
    _validation_errors = ...
    def __init__(self, etree=..., file=..., include=..., expand=..., include_params=..., expand_params=..., compile_params=..., store_schematron=..., store_xslt=..., store_report=..., phase=..., error_finder=..., validate_schema=...) -> None:
        ...
