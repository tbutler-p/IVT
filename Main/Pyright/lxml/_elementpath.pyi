...
xpath_tokenizer_re = ...
def xpath_tokenizer(pattern, namespaces=..., with_prefixes=...): # -> Generator[tuple[Any, LiteralString] | Any, Any, None]:
    ...
...
def findtext(elem, path, default=..., namespaces=..., with_prefixes=...): # -> Literal[''] | None:
    ...
