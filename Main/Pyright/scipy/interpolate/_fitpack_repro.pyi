...
def generate_knots(x, y, *, w=..., xb=..., xe=..., k=..., s=..., nest=...): # -> Generator[Incomplete | NDArray[Any], Any, None]:
...
def make_splprep(x, *, w=..., u=..., ub=..., ue=..., k=..., s=..., t=..., nest=...): # -> tuple[Any, Incomplete | Any] | tuple[BSpline, NDArray[Any]]:
    r"""
