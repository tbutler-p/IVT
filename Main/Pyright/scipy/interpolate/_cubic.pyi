...
def prepare_input(x, y, axis, dydx=...): # -> tuple[ndarray[_Shape, dtype[Any]], NDArray[Any], NDArray[Any], Any, NDArray[Any] | None]:
...
def pchip_interpolate(xi, yi, x, der=..., axis=...): # -> ndarray[tuple[int, ...], dtype[complex128 | float64]] | list[ndarray[tuple[int, ...], dtype[complex128 | float64]] | Any]:
    """
