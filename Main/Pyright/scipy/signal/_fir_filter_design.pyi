...
__all__ = ['kaiser_beta', 'kaiser_atten', 'kaiserord', 'firwin', 'firwin2', 'firwin_2d', 'remez', 'firls', 'minimum_phase']
...
def firwin(numtaps, cutoff, *, width=..., window=..., pass_zero=..., scale=..., fs=...): # -> Any:
    """
...
def firwin2(numtaps, freq, gain, *, nfreqs=..., window=..., antisymmetric=..., fs=...): # -> Any | tuple[Dispatchable, ...]:
    """
    FIR filter design using the window method.
...
def remez(numtaps, bands, desired, *, weight=..., type=..., maxiter=..., grid_density=..., fs=...): # -> Any:
    """
...
def firls(numtaps, bands, desired, *, weight=..., fs=...): # -> Any:
    """
...
def minimum_phase(h, method: Literal['homomorphic', 'hilbert'] = ..., n_fft: int | None = ..., *, half: bool = ...): # -> Any:
...
def firwin_2d(hsize, window, *, fc=..., fs=..., circular=..., pass_zero=..., scale=...): # -> NDArray[Any]:
    """
