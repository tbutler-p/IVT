...
def group_delay(system, w=..., whole=..., fs=...): # -> tuple[NDArray[floating[Any]] | NDArray[float64], ndarray[_Shape, dtype[float64]]]:
...
def tf2zpk(b, a): # -> tuple[Any, Any, Array | Any]:
...
def zpk2tf(z, p, k): # -> tuple[Any | Array, Array]:
    r"""
...
def sos2tf(sos): # -> tuple[Any | Array | NDArray[complex128] | NDArray[Any] | ndarray[_Shape, DType], Any | Array | NDArray[complex128] | NDArray[Any] | ndarray[_Shape, DType]]:
    r"""
...
def iirdesign(wp, ws, gpass, gstop, analog=..., ftype=..., output=..., fs=...): # -> tuple[Any | Array, Any | Array, Any] | tuple[Any | Array, Array] | Any | None:
...
def iirfilter(N, Wn, rp=..., rs=..., btype=..., analog=..., ftype=..., output=..., fs=...): # -> tuple[Any | Array, Any | Array, Any] | tuple[Any | Array, Array] | Any | None:
    """
...
def butter(N, Wn, btype=..., analog=..., output=..., fs=...): # -> tuple[Any | Array, Any | Array, Any] | tuple[Any | Array, Array] | Any | None:
    """
...
def cheby1(N, rp, Wn, btype=..., analog=..., output=..., fs=...): # -> tuple[Any | Array, Any | Array, Any] | tuple[Any | Array, Array] | Any | None:
    """
...
def cheby2(N, rs, Wn, btype=..., analog=..., output=..., fs=...): # -> tuple[Any | Array, Any | Array, Any] | tuple[Any | Array, Array] | Any | None:
    """
...
def ellip(N, rp, rs, Wn, btype=..., analog=..., output=..., fs=...): # -> tuple[Any | Array, Any | Array, Any] | tuple[Any | Array, Array] | Any | None:
    """
...
def bessel(N, Wn, btype=..., analog=..., output=..., norm=..., fs=...): # -> tuple[Any | Array, Any | Array, Any] | tuple[Any | Array, Array] | Any | None:
    """
...
def buttord(wp, ws, gpass, gstop, analog=..., fs=...): # -> tuple[int, Any | NDArray[float64] | NDArray[Any]]:
...
def cheb1ord(wp, ws, gpass, gstop, analog=..., fs=...): # -> tuple[int, Any | NDArray[float64]]:
...
def cheb2ord(wp, ws, gpass, gstop, analog=..., fs=...): # -> tuple[int, Any | NDArray[float64] | _Array1D[Any]]:
...
_POW10_LOG10 = ...
def ellipord(wp, ws, gpass, gstop, analog=..., fs=...): # -> tuple[int, Any | NDArray[float64]]:
...
def iircomb(w0, Q, ftype=..., fs=..., *, pass_zero=...): # -> tuple[_Array1D[float64], _Array1D[float64]]:
    """
...
def gammatone(freq, ftype, order=..., numtaps=..., fs=...): # -> tuple[Any | ndarray[_Shape, dtype[float64]] | _Array1D[float64], list[float] | _Array1D[float64] | Any]:
    """
