...
def periodogram(x, fs=..., window=..., nfft=..., detrend=..., return_onesided=..., scaling=..., axis=...): # -> tuple[_Array[tuple[int, ...], float64], _Array[tuple[int, ...], float64]] | tuple[NDArray[float64] | ndarray[Any, Any], ndarray[_Shape, dtype[float64]] | Any]:
    """
...
def welch(x, fs=..., window=..., nperseg=..., noverlap=..., nfft=..., detrend=..., return_onesided=..., scaling=..., axis=..., average=...): # -> tuple[NDArray[float64] | ndarray[Any, Any], ndarray[_Shape, dtype[float64]] | Any]:
    r"""
...
def csd(x, y, fs=..., window=..., nperseg=..., noverlap=..., nfft=..., detrend=..., return_onesided=..., scaling=..., axis=..., average=...): # -> tuple[NDArray[float64], NDArray[float64]] | tuple[ndarray[Any, Any], Any | ndarray[tuple[int, ...] | Any, dtype[Any]]]:
    r"""
...
def istft(Zxx, fs=..., window=..., nperseg=..., noverlap=..., nfft=..., input_onesided=..., boundary=..., time_axis=..., freq_axis=..., scaling=...): # -> tuple[NDArray[float64], NDArray[Any] | ndarray[_Shape, Any]]:
...
def coherence(x, y, fs=..., window=..., nperseg=..., noverlap=..., nfft=..., detrend=..., axis=...): # -> tuple[NDArray[float64] | ndarray[Any, Any], NDArray[float64] | Any]:
    r"""
