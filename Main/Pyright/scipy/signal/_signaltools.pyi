...
_modedict = ...
_boundarydict = ...
def correlate(in1, in2, mode=..., method=...): # -> NDArray[complex128] | Any | Array | NDArray[Any] | ndarray[_Shape, DType]:
    r"""
...
def convolve(in1, in2, mode=..., method=...): # -> Any | Array | NDArray[complex128] | NDArray[Any] | ndarray[_Shape, DType]:
    """
...
def lfilter(b, a, x, axis=..., zi=...): # -> Array | Any | tuple[Array | Any, Array | Any]:
    """
...
def deconvolve(signal, divisor): # -> tuple[scipy._lib.array_api_compat.numpy._typing.Array | Any | tuple[scipy._lib.array_api_compat.numpy._typing.Array | Any, scipy._lib.array_api_compat.numpy._typing.Array | Any] | list[Any], scipy._lib.array_api_extra._lib._utils._typing.Array | Any]:
...
def envelope(z, bp_in: tuple[int | None, int | None] = ..., *, n_out: int | None = ..., squared: bool = ..., residual: Literal['lowpass', 'all', None] = ..., axis: int = ...): # -> Any:
...
def invres(r, p, k, tol=..., rtype=...): # -> tuple[Any | Literal[0], NDArray[Any] | NDArray[numpy.bool[builtins.bool]]]:
...
def residue(b, a, tol=..., rtype=...): # -> tuple[_Array[tuple[int, ...], float64], NDArray[Any], NDArray[Any]] | tuple[Any, NDArray[complexfloating[Any, Any]] | NDArray[floating[Any]], _Array1D[float64] | NDArray[floating[Any]]]:
...
def residuez(b, a, tol=..., rtype=...): # -> tuple[_Array[tuple[int, ...], float64], NDArray[Any], NDArray[Any]] | tuple[Any, NDArray[complexfloating[Any, Any]] | NDArray[floating[Any]], ndarray[_Shape, dtype[float64]] | ndarray[_Shape, dtype[floating[Any]]]]:
...
def invresz(r, p, k, tol=..., rtype=...): # -> tuple[Any, NDArray[Any] | NDArray[numpy.bool[builtins.bool]]]:
...
def resample(x, num, t=..., axis=..., window=..., domain=...): # -> tuple[Any | tuple[Dispatchable], Any] | Any | tuple[Dispatchable]:
...
def filtfilt(b, a, x, axis=..., padtype=..., padlen=..., method=..., irlen=...): # -> Any:
    """
...
def sosfilt(sos, x, axis=..., zi=...): # -> tuple[Array | Any, Array | Any] | Array | Any:
    """
...
def decimate(x, q, n=..., ftype=..., axis=..., zero_phase=...): # -> Any | ndarray[_Shape, DType]:
    """
