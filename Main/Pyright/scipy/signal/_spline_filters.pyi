...
def compute_root_from_lambda(lamb): # -> tuple[Any, float]:
    ...
...
def collapse_2d(x, axis): # -> tuple[ndarray[tuple[int, int], dtype[Any]], _Shape]:
    ...
...
def cspline1d_eval(cj, newx, dx=..., x0=...): # -> Any:
...
def qspline1d_eval(cj, newx, dx=..., x0=...): # -> Any:
