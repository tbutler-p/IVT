...
def diric(x, n): # -> _Array[tuple[int, ...], Any]:
...
def riccati_jn(n, x): # -> tuple[ndarray[_Shape, dtype[float64]], ndarray[_Shape, dtype[float64]]]:
...
def riccati_yn(n, x): # -> tuple[ndarray[_Shape, dtype[float64]], ndarray[_Shape, dtype[float64]]]:
...
def lpmn(m, n, z): # -> tuple[ndarray[_Shape, dtype[Any]], ndarray[_Shape, dtype[Any]]]:
...
def clpmn(m, n, z, type=...): # -> tuple[ndarray[_Shape, dtype[Any]], ndarray[_Shape, dtype[Any]]]:
...
def lqmn(m, n, z): # -> tuple[ndarray[_Shape, dtype[complex128]] | ndarray[_Shape, dtype[float64]], ndarray[_Shape, dtype[complex128]] | ndarray[_Shape, dtype[float64]]]:
...
def lqn(n, z): # -> tuple[ndarray[_Shape, dtype[complex128]] | ndarray[_Shape, dtype[float64]], ndarray[_Shape, dtype[complex128]] | ndarray[_Shape, dtype[float64]]]:
