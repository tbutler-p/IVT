...
def scoreatpercentile(a, per, limit=..., interpolation_method=..., axis=...): # -> float | _Array[tuple[int, ...], float64] | NDArray[Any] | Any:
...
def median_abs_deviation(x, axis=..., center=..., scale=..., nan_policy=...): # -> float | _Array[tuple[int, ...], Any] | NDArray[float64] | Any:
    r"""
...
def trim1(a, proportiontocut, tail=..., axis=...): # -> list[Any] | ndarray[_Shape, dtype[Any]]:
...
def quantile_test_iv(x, q, p, alternative): # -> tuple[NDArray[Any], ndarray[_Shape, dtype[Any]], ndarray[_Shape, dtype[Any]], Any]:
    ...
