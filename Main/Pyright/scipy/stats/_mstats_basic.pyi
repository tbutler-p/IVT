...
def find_repeats(arr): # -> tuple[NDArray[float64], NDArray[signedinteger[_NBitIntP]]] | tuple[ndarray[_Shape, dtype[float64]], ndarray[_Shape, dtype[Any]]]:
...
def rankdata(data, axis=..., use_missing=...): # -> NDArray[Any]:
