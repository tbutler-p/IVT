...
class VarReader4:
    ...
    def array_from_header(self, hdr, process=...): # -> coo_array | NDArray[complex128] | ndarray[Any, Any]:
        ...
    ...
    def read_full_array(self, hdr): # -> NDArray[complex128] | ndarray[Any, Any]:
...
class MatFile4Reader(MatFileReader):
    ...
    def read_var_array(self, header, process=...): # -> coo_array | NDArray[complex128] | ndarray[Any, Any]:
