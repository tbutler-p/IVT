...
def newton(func, x0, fprime=..., args=..., tol=..., maxiter=..., fprime2=..., x1=..., rtol=..., full_output=..., disp=...): # -> result | NDArray[Any] | NDArray[float64] | tuple[NDArray[float64] | Any, RootResults] | tuple[Any, RootResults]:
    """
