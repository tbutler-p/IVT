...
def initial_constraints_as_canonical(n, prepared_constraints, sparse_jacobian): # -> tuple[NDArray[Any] | _Array1D[float64], NDArray[Any] | _Array1D[float64], NDArray[Any] | Any | csr_matrix | csc_matrix | csr_array | csc_array | coo_matrix | coo_array | _Array[tuple[int, int], float64], NDArray[Any] | Any | csr_matrix | csc_matrix | csr_array | csc_array | coo_matrix | coo_array | _Array[tuple[int, int], float64]]:
