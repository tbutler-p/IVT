...
def find_root(f, init, /, *, args=..., tolerances=..., maxiter=..., callback=...): # -> _RichResult:
...
def find_minimum(f, init, /, *, args=..., tolerances=..., maxiter=..., callback=...): # -> _RichResult:
...
def bracket_root(f, xl0, xr0=..., *, xmin=..., xmax=..., factor=..., args=..., maxiter=...): # -> _RichResult:
...
def bracket_minimum(f, xm0, *, xl0=..., xr0=..., xmin=..., xmax=..., factor=..., args=..., maxiter=...): # -> _RichResult:
