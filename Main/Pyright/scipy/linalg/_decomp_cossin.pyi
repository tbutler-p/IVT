...
__all__ = ['cossin']
def cossin(X, p=..., q=..., separate=..., swap_sign=..., compute_u=..., compute_vh=...): # -> tuple[tuple[Any, Any], Any, tuple[Any, Any]] | tuple[ndarray[tuple[int, ...], dtype[Any]], Any, ndarray[tuple[int, ...], dtype[Any]]]:
    """
