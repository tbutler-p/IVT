...
def eig_banded(a_band, lower=..., eigvals_only=..., overwrite_a_band=..., select=..., select_range=..., max_ev=..., check_finite=...): # -> NDArray[float64] | tuple[NDArray[float64], NDArray[float64] | NDArray[Any]] | tuple[Any, Any]:
    """
...
def hessenberg(a, calc_q=..., overwrite_a=..., check_finite=...): # -> tuple[Any, Any] | tuple[NDArray[float64] | NDArray[Any], NDArray[float64]] | NDArray[float64] | NDArray[Any] | tuple[NDArray[Any], Any]:
    """
