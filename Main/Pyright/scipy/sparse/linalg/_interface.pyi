...
class LinearOperator:
    ...
    def __mul__(self, x): # -> _ProductLinearOperator | _ScaledLinearOperator | NDArray[Any] | ndarray[tuple[int, int], Any] | ndarray[tuple[int, int], dtype[Any]] | matrix[Any, Any]:
        ...
    
    def __truediv__(self, other): # -> _ScaledLinearOperator:
        ...
    
    def dot(self, x): # -> _ProductLinearOperator | _ScaledLinearOperator | NDArray[Any] | ndarray[tuple[int, int], Any] | ndarray[tuple[int, int], dtype[Any]] | matrix[Any, Any]:
    ...
    def __matmul__(self, other): # -> _ProductLinearOperator | _ScaledLinearOperator | NDArray[Any] | ndarray[tuple[int, int], Any] | ndarray[tuple[int, int], dtype[Any]] | matrix[Any, Any]:
        ...
