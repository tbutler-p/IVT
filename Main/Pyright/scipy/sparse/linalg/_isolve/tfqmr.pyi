...
__all__ = ['tfqmr']
def tfqmr(A, b, x0=..., *, rtol=..., atol=..., maxiter=..., M=..., callback=..., show=...): # -> tuple[ndarray[tuple[int], dtype[Any]], Literal[0]] | tuple[NDArray[Any] | Any | ndarray[tuple[int, int], Any] | ndarray[tuple[int, int], dtype[Any]] | ndarray[tuple[int], dtype[Any]], Literal[0]] | tuple[NDArray[Any] | Any | ndarray[tuple[int, int], Any] | ndarray[tuple[int, int], dtype[Any]] | ndarray[tuple[int], dtype[Any]], Literal[-1]] | tuple[Any, Literal[0]] | tuple[NDArray[Any] | Any | ndarray[tuple[int, int], Any] | ndarray[tuple[int, int], dtype[Any]] | ndarray[tuple[int], dtype[Any]], int | Any]:
    """
