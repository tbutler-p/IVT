...
of_the_second_derivative
    ...
    def eigenvalues(self, m=...): # -> ndarray[_Shape, dtype[float64]] | Any:
    ...
    def toarray(self): # -> ndarray[_Shape, dtype[int_ | numpy.bool[builtins.bool]]]:
        """
...
class Sakurai(LinearOperator):
    ...
    def tobanded(self): # -> ndarray[_Shape, dtype[signedinteger[_8Bit]]]:
        """
...
class MikotaM(LinearOperator):
    ...
    def toarray(self): # -> ndarray[_Shape, dtype[float64]]:
        ...
