...
class _dia_base(_data_matrix):
    ...
    def sum(self, axis=..., dtype=..., out=...): # -> Any | matrix[_2D, Any]:
        ...
    ...
    def diagonal(self, k=...): # -> ndarray[tuple[int], dtype[float64 | int_ | numpy.bool[builtins.bool]]] | NDArray[Any] | NDArray[float64 | int_ | numpy.bool[builtins.bool]] | ndarray[_Shape, dtype[Any]] | ndarray[_Shape, dtype[float64]]:
        ...
