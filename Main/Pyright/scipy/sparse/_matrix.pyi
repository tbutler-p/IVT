...
class spmatrix:
    ...
    def __pow__(self, power): # -> coo_array | coo_matrix | dia_array | Any | dia_matrix | _NotImplementedType | ndarray[tuple[int], dtype[Any]] | ndarray[tuple[int], Any] | ndarray[tuple[int, int], dtype[Any]] | ndarray[tuple[int, int], Any] | NDArray[Any] | matrix[Any, Any]:
        ...
