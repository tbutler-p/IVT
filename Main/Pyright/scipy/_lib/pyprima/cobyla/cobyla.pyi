...
def cobyla(calcfc, m_nlcon, x, Aineq=..., bineq=..., Aeq=..., beq=..., xl=..., xu=..., f0=..., nlconstr0=..., rhobeg=..., rhoend=..., ftarget=..., ctol=..., cweight=..., maxfun=..., iprint=..., eta1=..., eta2=..., gamma1=..., gamma2=..., maxhist=..., maxfilt=..., callback=...):
    """
...
def get_lincon(Aeq=..., Aineq=..., beq=..., bineq=..., xl=..., xu=...): # -> tuple[None, None] | tuple[NDArray[float64] | None, NDArray[float64] | None]:
    """
