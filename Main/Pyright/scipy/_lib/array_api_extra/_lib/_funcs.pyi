...
def create_diagonal(x: Array, /, *, offset: int = ..., xp: ModuleType | None = ...) -> Array:
    """
...
def expand_dims(a: Array, /, *, axis: int | tuple[int, ...] = ..., xp: ModuleType | None = ...) -> Array:
    """
...
def setdiff1d(x1: Array | complex, x2: Array | complex, /, *, assume_unique: bool = ..., xp: ModuleType | None = ...) -> Array:
    """
