...
def buildTransform(input_profile: CmsProfile, output_profile: CmsProfile, in_mode: str, out_mode: str, rendering_intent: int = ..., cms_flags: int = ..., /) -> CmsTransform:
    ...

def buildProofTransform(input_profile: CmsProfile, output_profile: CmsProfile, proof_profile: CmsProfile, in_mode: str, out_mode: str, rendering_intent: int = ..., proof_intent: int = ..., cms_flags: int = ..., /) -> CmsTransform:
    ...

def createProfile(color_space: Literal["LAB", "XYZ", "sRGB"], color_temp: SupportsFloat = ..., /) -> CmsProfile:
    ...
