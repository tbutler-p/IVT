...
from . import ImageFile, ImageFilter, ImagePalette, ImageQt, __version__, _imaging as core
...
class Image:
    ...
    * :py:func:`~PIL.Image.frombytes`
    ...
    def frombytes(self, data: bytes | bytearray | SupportsArrayInterface, decoder_name: str = ..., *args: Any) -> None:
        """
    ...
    def convert(self, mode: str | None = ..., matrix: tuple[float, ...] | None = ..., dither: Dither | None = ..., palette: Palette = ..., colors: int = ...) -> Image:
        """
    ...
    def quantize(self, colors: int = ..., method: int | None = ..., kmeans: int = ..., palette: Image | None = ..., dither: Dither = ...) -> Image:
        """
    ...
    __copy__ = ...
    def crop(self, box: tuple[float, float, float, float] | None = ...) -> Image:
        """
    ...
    def getbbox(self, *, alpha_only: bool = ...) -> tuple[int, int, int, int] | None:
        """
    ...
    def getcolors(self, maxcolors: int = ...) -> list[tuple[int, tuple[int, ...]]] | list[tuple[int, float]] | None:
        """
    ...
    def getdata(self, band: int | None = ...) -> core.ImagingCore:
        """
    ...
    def histogram(self, mask: Image | None = ..., extrema: tuple[float, float] | None = ...) -> list[int]:
        """
    ...
    def entropy(self, mask: Image | None = ..., extrema: tuple[float, float] | None = ...) -> float:
        """
    ...
    def paste(self, im: Image | str | float | tuple[float, ...], box: Image | tuple[int, int, int, int] | tuple[int, int] | None = ..., mask: Image | None = ...) -> None:
        """
    ...
    def alpha_composite(self, im: Image, dest: Sequence[int] = ..., source: Sequence[int] = ...) -> None:
    ...
    def point(self, lut: (Sequence[float] | NumpyArray | Callable[[int], float] | Callable[[ImagePointTransform], ImagePointTransform | float] | ImagePointHandler), mode: str | None = ...) -> Image:
        """
    ...
    def putdata(self, data: Sequence[float] | Sequence[Sequence[int]] | core.ImagingCore | NumpyArray, scale: float = ..., offset: float = ...) -> None:
        """
    ...
    def putpalette(self, data: ImagePalette.ImagePalette | bytes | Sequence[int], rawmode: str = ...) -> None:
        """
    ...
    def remap_palette(self, dest_map: list[int], source_palette: bytes | bytearray | None = ...) -> Image:
        """
    ...
    def resize(self, size: tuple[int, int] | list[int] | NumpyArray, resample: int | None = ..., box: tuple[float, float, float, float] | None = ..., reducing_gap: float | None = ...) -> Image:
        """
    ...
    def reduce(self, factor: int | tuple[int, int], box: tuple[int, int, int, int] | None = ...) -> Image:
        """
    ...
    def rotate(self, angle: float, resample: Resampling = ..., expand: int | bool = ..., center: tuple[float, float] | None = ..., translate: tuple[int, int] | None = ..., fillcolor: float | tuple[float, ...] | str | None = ...) -> Image:
        """
    ...
    def save(self, fp: StrOrBytesPath | IO[bytes], format: str | None = ..., **params: Any) -> None:
        """
    ...
    def thumbnail(self, size: tuple[float, float], resample: Resampling = ..., reducing_gap: float | None = ...) -> None:
        """
    ...
    def transform(self, size: tuple[int, int], method: Transform | ImageTransformHandler | SupportsGetData, data: Sequence[Any] | None = ..., resample: int = ..., fill: int = ..., fillcolor: float | tuple[float, ...] | str | None = ...) -> Image:
        """
...
def new(mode: str, size: tuple[int, int] | list[int], color: float | tuple[float, ...] | str | None = ...) -> Image:
    """
...
def frombytes(mode: str, size: tuple[int, int], data: bytes | bytearray | SupportsArrayInterface, decoder_name: str = ..., *args: Any) -> Image:
    """
...
def frombuffer(mode: str, size: tuple[int, int], data: bytes | SupportsArrayInterface, decoder_name: str = ..., *args: Any) -> Image:
    """
...
class SupportsArrowArrayInterface(Protocol):
    ...
    data interface.
    """
    def __arrow_c_array__(self, requested_schema: PyCapsule = ...) -> tuple[PyCapsule, PyCapsule]:
        ...
    


def fromarray(obj: SupportsArrayInterface, mode: str | None = ...) -> Image:
    """
...
_fromarray_typemap = ...
def open(fp: StrOrBytesPath | IO[bytes], mode: Literal["r"] = ..., formats: list[str] | tuple[str, ...] | None = ...) -> ImageFile.ImageFile:
    """
...
def register_open(id: str, factory: (Callable[[IO[bytes], str | bytes], ImageFile.ImageFile] | type[ImageFile.ImageFile]), accept: Callable[[bytes], bool | str] | None = ...) -> None:
    """
...
class Exif(_ExifBase):
    ...
    def load_from_fp(self, fp: IO[bytes], offset: int | None = ...) -> None:
        ...
