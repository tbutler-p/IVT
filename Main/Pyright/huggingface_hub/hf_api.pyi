...
from typing import Any, BinaryIO, Callable, Dict, Iterable, Iterator, List, Literal, Optional, TYPE_CHECKING, Tuple, Type, TypeVar, Union, overload
...
from .community import Discussion, DiscussionComment, DiscussionStatusChange, DiscussionTitleChange, DiscussionWithDetails
...
ExpandModelProperty_T = Literal["author", "baseModels", "cardData", "childrenModelCount", "config", "createdAt", "disabled", "downloads", "downloadsAllTime", "gated", "gguf", "inference", "inferenceProviderMapping", "lastModified", "library_name", "likes", "mask_token", "model-index", "pipeline_tag", "private", "resourceGroup", "safetensors", "sha", "siblings", "spaces", "tags", "transformersInfo", "trendingScore", "usedStorage", "widgetData", "xetEnabled",]
ExpandDatasetProperty_T = Literal["author", "cardData", "citation", "createdAt", "description", "disabled", "downloads", "downloadsAllTime", "gated", "lastModified", "likes", "paperswithcode_id", "private", "resourceGroup", "sha", "siblings", "tags", "trendingScore", "usedStorage", "xetEnabled",]
ExpandSpaceProperty_T = Literal["author", "cardData", "createdAt", "datasets", "disabled", "lastModified", "likes", "models", "private", "resourceGroup", "runtime", "sdk", "sha", "siblings", "subdomain", "tags", "trendingScore", "usedStorage", "xetEnabled",]
...
class CollectionItem:
    ...
    position: int
    note: Optional[str] = ...
    def __init__(self, _id: str, id: str, type: CollectionItemType_T, position: int, note: Optional[Dict] = ..., **kwargs) -> None:
        ...
...
class HfApi:
    ...
    """
    def __init__(self, endpoint: Optional[str] = ..., token: Union[str, bool, None] = ..., library_name: Optional[str] = ..., library_version: Optional[str] = ..., user_agent: Union[Dict, str, None] = ..., headers: Optional[Dict[str, str]] = ...) -> None:
        ...
    ...
    @_deprecate_method(version="1.0", message="Permissions are more complex than when `get_token_permission` was first introduced. " "OAuth and fine-grain tokens allows for more detailed permissions. " "If you need to know the permissions associated with a token, please use `whoami` and check the `'auth'` key.")
    def get_token_permission(self, token: Union[bool, str, None] = ...) -> Literal["read", "write", "fineGrained", None]:
        """
    ...
    @_deprecate_arguments(version="1.0", deprecated_args=["language", "library", "task", "tags"], custom_message="Use `filter` instead.")
    @validate_hf_hub_args
    def list_models(self, *, filter: Union[str, Iterable[str], None] = ..., author: Optional[str] = ..., apps: Optional[Union[str, List[str]]] = ..., gated: Optional[bool] = ..., inference: Optional[Literal["warm"]] = ..., inference_provider: Optional[Union[Literal["all"], PROVIDER_T, List[PROVIDER_T]]] = ..., model_name: Optional[str] = ..., trained_dataset: Optional[Union[str, List[str]]] = ..., search: Optional[str] = ..., pipeline_tag: Optional[str] = ..., emissions_thresholds: Optional[Tuple[float, float]] = ..., sort: Union[Literal["last_modified"], str, None] = ..., direction: Optional[Literal[-1]] = ..., limit: Optional[int] = ..., expand: Optional[List[ExpandModelProperty_T]] = ..., full: Optional[bool] = ..., cardData: bool = ..., fetch_config: bool = ..., token: Union[bool, str, None] = ..., language: Optional[Union[str, List[str]]] = ..., library: Optional[Union[str, List[str]]] = ..., tags: Optional[Union[str, List[str]]] = ..., task: Optional[Union[str, List[str]]] = ...) -> Iterable[ModelInfo]:
        """
    ...
    @validate_hf_hub_args
    def list_datasets(self, *, filter: Union[str, Iterable[str], None] = ..., author: Optional[str] = ..., benchmark: Optional[Union[str, List[str]]] = ..., dataset_name: Optional[str] = ..., gated: Optional[bool] = ..., language_creators: Optional[Union[str, List[str]]] = ..., language: Optional[Union[str, List[str]]] = ..., multilinguality: Optional[Union[str, List[str]]] = ..., size_categories: Optional[Union[str, List[str]]] = ..., task_categories: Optional[Union[str, List[str]]] = ..., task_ids: Optional[Union[str, List[str]]] = ..., search: Optional[str] = ..., sort: Optional[Union[Literal["last_modified"], str]] = ..., direction: Optional[Literal[-1]] = ..., limit: Optional[int] = ..., expand: Optional[List[ExpandDatasetProperty_T]] = ..., full: Optional[bool] = ..., token: Union[bool, str, None] = ..., tags: Optional[Union[str, List[str]]] = ...) -> Iterable[DatasetInfo]:
        """
    ...
    @validate_hf_hub_args
    def list_spaces(self, *, filter: Union[str, Iterable[str], None] = ..., author: Optional[str] = ..., search: Optional[str] = ..., datasets: Union[str, Iterable[str], None] = ..., models: Union[str, Iterable[str], None] = ..., linked: bool = ..., sort: Union[Literal["last_modified"], str, None] = ..., direction: Optional[Literal[-1]] = ..., limit: Optional[int] = ..., expand: Optional[List[ExpandSpaceProperty_T]] = ..., full: Optional[bool] = ..., token: Union[bool, str, None] = ...) -> Iterable[SpaceInfo]:
        """
    ...
    @validate_hf_hub_args
    def list_repo_likers(self, repo_id: str, *, repo_type: Optional[str] = ..., token: Union[bool, str, None] = ...) -> Iterable[User]:
        """
    ...
    @validate_hf_hub_args
    def model_info(self, repo_id: str, *, revision: Optional[str] = ..., timeout: Optional[float] = ..., securityStatus: Optional[bool] = ..., files_metadata: bool = ..., expand: Optional[List[ExpandModelProperty_T]] = ..., token: Union[bool, str, None] = ...) -> ModelInfo:
        """
    ...
    @validate_hf_hub_args
    def dataset_info(self, repo_id: str, *, revision: Optional[str] = ..., timeout: Optional[float] = ..., files_metadata: bool = ..., expand: Optional[List[ExpandDatasetProperty_T]] = ..., token: Union[bool, str, None] = ...) -> DatasetInfo:
        """
    ...
    @validate_hf_hub_args
    def space_info(self, repo_id: str, *, revision: Optional[str] = ..., timeout: Optional[float] = ..., files_metadata: bool = ..., expand: Optional[List[ExpandSpaceProperty_T]] = ..., token: Union[bool, str, None] = ...) -> SpaceInfo:
        """
    ...
    @validate_hf_hub_args
    def repo_info(self, repo_id: str, *, revision: Optional[str] = ..., repo_type: Optional[str] = ..., timeout: Optional[float] = ..., files_metadata: bool = ..., expand: Optional[Union[ExpandModelProperty_T, ExpandDatasetProperty_T, ExpandSpaceProperty_T]] = ..., token: Union[bool, str, None] = ...) -> Union[ModelInfo, DatasetInfo, SpaceInfo]:
        """
    ...
    @validate_hf_hub_args
    def revision_exists(self, repo_id: str, revision: str, *, repo_type: Optional[str] = ..., token: Union[str, bool, None] = ...) -> bool:
        """
    ...
    @validate_hf_hub_args
    def file_exists(self, repo_id: str, filename: str, *, repo_type: Optional[str] = ..., revision: Optional[str] = ..., token: Union[str, bool, None] = ...) -> bool:
        """
    ...
    @validate_hf_hub_args
    def list_repo_files(self, repo_id: str, *, revision: Optional[str] = ..., repo_type: Optional[str] = ..., token: Union[str, bool, None] = ...) -> List[str]:
        """
    ...
    @validate_hf_hub_args
    def list_repo_tree(self, repo_id: str, path_in_repo: Optional[str] = ..., *, recursive: bool = ..., expand: bool = ..., revision: Optional[str] = ..., repo_type: Optional[str] = ..., token: Union[str, bool, None] = ...) -> Iterable[Union[RepoFile, RepoFolder]]:
        """
    ...
    @validate_hf_hub_args
    def list_repo_refs(self, repo_id: str, *, repo_type: Optional[str] = ..., include_pull_requests: bool = ..., token: Union[str, bool, None] = ...) -> GitRefs:
        """
    ...
    @validate_hf_hub_args
    def list_repo_commits(self, repo_id: str, *, repo_type: Optional[str] = ..., token: Union[bool, str, None] = ..., revision: Optional[str] = ..., formatted: bool = ...) -> List[GitCommitInfo]:
        """
    ...
    @validate_hf_hub_args
    def get_paths_info(self, repo_id: str, paths: Union[List[str], str], *, expand: bool = ..., revision: Optional[str] = ..., repo_type: Optional[str] = ..., token: Union[str, bool, None] = ...) -> List[Union[RepoFile, RepoFolder]]:
        """
    ...
    @validate_hf_hub_args
    def super_squash_history(self, repo_id: str, *, branch: Optional[str] = ..., commit_message: Optional[str] = ..., repo_type: Optional[str] = ..., token: Union[str, bool, None] = ...) -> None:
    ...
    @validate_hf_hub_args
    def list_lfs_files(self, repo_id: str, *, repo_type: Optional[str] = ..., token: Union[bool, str, None] = ...) -> Iterable[LFSFileInfo]:
        """
    ...
    @validate_hf_hub_args
    def permanently_delete_lfs_files(self, repo_id: str, lfs_files: Iterable[LFSFileInfo], *, rewrite_history: bool = ..., repo_type: Optional[str] = ..., token: Union[bool, str, None] = ...) -> None:
        """
    ...
    @validate_hf_hub_args
    def create_repo(self, repo_id: str, *, token: Union[str, bool, None] = ..., private: Optional[bool] = ..., repo_type: Optional[str] = ..., exist_ok: bool = ..., resource_group_id: Optional[str] = ..., space_sdk: Optional[str] = ..., space_hardware: Optional[SpaceHardware] = ..., space_storage: Optional[SpaceStorage] = ..., space_sleep_time: Optional[int] = ..., space_secrets: Optional[List[Dict[str, str]]] = ..., space_variables: Optional[List[Dict[str, str]]] = ...) -> RepoUrl:
    ...
    @validate_hf_hub_args
    def delete_repo(self, repo_id: str, *, token: Union[str, bool, None] = ..., repo_type: Optional[str] = ..., missing_ok: bool = ...) -> None:
        """
    ...
    @validate_hf_hub_args
    def update_repo_visibility(self, repo_id: str, private: bool = ..., *, token: Union[str, bool, None] = ..., repo_type: Optional[str] = ...) -> Dict[str, bool]:
    ...
    @validate_hf_hub_args
    def update_repo_settings(self, repo_id: str, *, gated: Optional[Literal["auto", "manual", False]] = ..., private: Optional[bool] = ..., token: Union[str, bool, None] = ..., repo_type: Optional[str] = ..., xet_enabled: Optional[bool] = ...) -> None:
        """
    ...
    def move_repo(self, from_id: str, to_id: str, *, repo_type: Optional[str] = ..., token: Union[str, bool, None] = ...): # -> None:
        """
    ...
    @overload
    def create_commit(self, repo_id: str, operations: Iterable[CommitOperation], *, commit_message: str, commit_description: Optional[str] = ..., token: Union[str, bool, None] = ..., repo_type: Optional[str] = ..., revision: Optional[str] = ..., create_pr: Optional[bool] = ..., num_threads: int = ..., parent_commit: Optional[str] = ..., run_as_future: Literal[False] = ...) -> CommitInfo:
        ...
    
    @overload
    def create_commit(self, repo_id: str, operations: Iterable[CommitOperation], *, commit_message: str, commit_description: Optional[str] = ..., token: Union[str, bool, None] = ..., repo_type: Optional[str] = ..., revision: Optional[str] = ..., create_pr: Optional[bool] = ..., num_threads: int = ..., parent_commit: Optional[str] = ..., run_as_future: Literal[True] = ...) -> Future[CommitInfo]:
        ...
    
    @validate_hf_hub_args
    @future_compatible
    def create_commit(self, repo_id: str, operations: Iterable[CommitOperation], *, commit_message: str, commit_description: Optional[str] = ..., token: Union[str, bool, None] = ..., repo_type: Optional[str] = ..., revision: Optional[str] = ..., create_pr: Optional[bool] = ..., num_threads: int = ..., parent_commit: Optional[str] = ..., run_as_future: bool = ...) -> Union[CommitInfo, Future[CommitInfo]]:
        """
    ...
    def preupload_lfs_files(self, repo_id: str, additions: Iterable[CommitOperationAdd], *, token: Union[str, bool, None] = ..., repo_type: Optional[str] = ..., revision: Optional[str] = ..., create_pr: Optional[bool] = ..., num_threads: int = ..., free_memory: bool = ..., gitignore_content: Optional[str] = ...): # -> None:
    ...
    @overload
    def upload_file(self, *, path_or_fileobj: Union[str, Path, bytes, BinaryIO], path_in_repo: str, repo_id: str, token: Union[str, bool, None] = ..., repo_type: Optional[str] = ..., revision: Optional[str] = ..., commit_message: Optional[str] = ..., commit_description: Optional[str] = ..., create_pr: Optional[bool] = ..., parent_commit: Optional[str] = ..., run_as_future: Literal[False] = ...) -> CommitInfo:
        ...
    ...
    @validate_hf_hub_args
    @future_compatible
    def upload_file(self, *, path_or_fileobj: Union[str, Path, bytes, BinaryIO], path_in_repo: str, repo_id: str, token: Union[str, bool, None] = ..., repo_type: Optional[str] = ..., revision: Optional[str] = ..., commit_message: Optional[str] = ..., commit_description: Optional[str] = ..., create_pr: Optional[bool] = ..., parent_commit: Optional[str] = ..., run_as_future: bool = ...) -> Union[CommitInfo, Future[CommitInfo]]:
        """
    ...
    @overload
    def upload_folder(self, *, repo_id: str, folder_path: Union[str, Path], path_in_repo: Optional[str] = ..., commit_message: Optional[str] = ..., commit_description: Optional[str] = ..., token: Union[str, bool, None] = ..., repo_type: Optional[str] = ..., revision: Optional[str] = ..., create_pr: Optional[bool] = ..., parent_commit: Optional[str] = ..., allow_patterns: Optional[Union[List[str], str]] = ..., ignore_patterns: Optional[Union[List[str], str]] = ..., delete_patterns: Optional[Union[List[str], str]] = ..., run_as_future: Literal[False] = ...) -> CommitInfo:
        ...
    ...
    @validate_hf_hub_args
    @future_compatible
    def upload_folder(self, *, repo_id: str, folder_path: Union[str, Path], path_in_repo: Optional[str] = ..., commit_message: Optional[str] = ..., commit_description: Optional[str] = ..., token: Union[str, bool, None] = ..., repo_type: Optional[str] = ..., revision: Optional[str] = ..., create_pr: Optional[bool] = ..., parent_commit: Optional[str] = ..., allow_patterns: Optional[Union[List[str], str]] = ..., ignore_patterns: Optional[Union[List[str], str]] = ..., delete_patterns: Optional[Union[List[str], str]] = ..., run_as_future: bool = ...) -> Union[CommitInfo, Future[CommitInfo]]:
        """
    ...
    @validate_hf_hub_args
    def delete_file(self, path_in_repo: str, repo_id: str, *, token: Union[str, bool, None] = ..., repo_type: Optional[str] = ..., revision: Optional[str] = ..., commit_message: Optional[str] = ..., commit_description: Optional[str] = ..., create_pr: Optional[bool] = ..., parent_commit: Optional[str] = ...) -> CommitInfo:
        """
    ...
    @validate_hf_hub_args
    def delete_files(self, repo_id: str, delete_patterns: List[str], *, token: Union[bool, str, None] = ..., repo_type: Optional[str] = ..., revision: Optional[str] = ..., commit_message: Optional[str] = ..., commit_description: Optional[str] = ..., create_pr: Optional[bool] = ..., parent_commit: Optional[str] = ...) -> CommitInfo:
        """
    ...
    @validate_hf_hub_args
    def delete_folder(self, path_in_repo: str, repo_id: str, *, token: Union[bool, str, None] = ..., repo_type: Optional[str] = ..., revision: Optional[str] = ..., commit_message: Optional[str] = ..., commit_description: Optional[str] = ..., create_pr: Optional[bool] = ..., parent_commit: Optional[str] = ...) -> CommitInfo:
        """
    ...
    def upload_large_folder(self, repo_id: str, folder_path: Union[str, Path], *, repo_type: str, revision: Optional[str] = ..., private: Optional[bool] = ..., allow_patterns: Optional[Union[List[str], str]] = ..., ignore_patterns: Optional[Union[List[str], str]] = ..., num_workers: Optional[int] = ..., print_report: bool = ..., print_report_every: int = ...) -> None:
    ...
    @validate_hf_hub_args
    def get_hf_file_metadata(self, *, url: str, token: Union[bool, str, None] = ..., proxies: Optional[Dict] = ..., timeout: Optional[float] = ...) -> HfFileMetadata:
    ...
    @validate_hf_hub_args
    def hf_hub_download(self, repo_id: str, filename: str, *, subfolder: Optional[str] = ..., repo_type: Optional[str] = ..., revision: Optional[str] = ..., cache_dir: Union[str, Path, None] = ..., local_dir: Union[str, Path, None] = ..., force_download: bool = ..., proxies: Optional[Dict] = ..., etag_timeout: float = ..., token: Union[bool, str, None] = ..., local_files_only: bool = ..., resume_download: Optional[bool] = ..., force_filename: Optional[str] = ..., local_dir_use_symlinks: Union[bool, Literal["auto"]] = ...) -> str:
    ...
    @validate_hf_hub_args
    def snapshot_download(self, repo_id: str, *, repo_type: Optional[str] = ..., revision: Optional[str] = ..., cache_dir: Union[str, Path, None] = ..., local_dir: Union[str, Path, None] = ..., proxies: Optional[Dict] = ..., etag_timeout: float = ..., force_download: bool = ..., token: Union[bool, str, None] = ..., local_files_only: bool = ..., allow_patterns: Optional[Union[List[str], str]] = ..., ignore_patterns: Optional[Union[List[str], str]] = ..., max_workers: int = ..., tqdm_class: Optional[Type[base_tqdm]] = ..., local_dir_use_symlinks: Union[bool, Literal["auto"]] = ..., resume_download: Optional[bool] = ...) -> str:
        """Download repo files.
    ...
    def get_safetensors_metadata(self, repo_id: str, *, repo_type: Optional[str] = ..., revision: Optional[str] = ..., token: Union[bool, str, None] = ...) -> SafetensorsRepoMetadata:
        """
    ...
    def parse_safetensors_file_metadata(self, repo_id: str, filename: str, *, repo_type: Optional[str] = ..., revision: Optional[str] = ..., token: Union[bool, str, None] = ...) -> SafetensorsFileMetadata:
        """
    ...
    @validate_hf_hub_args
    def create_branch(self, repo_id: str, *, branch: str, revision: Optional[str] = ..., token: Union[bool, str, None] = ..., repo_type: Optional[str] = ..., exist_ok: bool = ...) -> None:
        """
    ...
    @validate_hf_hub_args
    def delete_branch(self, repo_id: str, *, branch: str, token: Union[bool, str, None] = ..., repo_type: Optional[str] = ...) -> None:
        """
    ...
    @validate_hf_hub_args
    def create_tag(self, repo_id: str, *, tag: str, tag_message: Optional[str] = ..., revision: Optional[str] = ..., token: Union[bool, str, None] = ..., repo_type: Optional[str] = ..., exist_ok: bool = ...) -> None:
        """
    ...
    @validate_hf_hub_args
    def delete_tag(self, repo_id: str, *, tag: str, token: Union[bool, str, None] = ..., repo_type: Optional[str] = ...) -> None:
        """
    ...
    @validate_hf_hub_args
    def get_full_repo_name(self, model_id: str, *, organization: Optional[str] = ..., token: Union[bool, str, None] = ...): # -> str:
        """
    ...
    @validate_hf_hub_args
    def get_repo_discussions(self, repo_id: str, *, author: Optional[str] = ..., discussion_type: Optional[constants.DiscussionTypeFilter] = ..., discussion_status: Optional[constants.DiscussionStatusFilter] = ..., repo_type: Optional[str] = ..., token: Union[bool, str, None] = ...) -> Iterator[Discussion]:
        """
    ...
    @validate_hf_hub_args
    def get_discussion_details(self, repo_id: str, discussion_num: int, *, repo_type: Optional[str] = ..., token: Union[bool, str, None] = ...) -> DiscussionWithDetails:
    ...
    @validate_hf_hub_args
    def create_discussion(self, repo_id: str, title: str, *, token: Union[bool, str, None] = ..., description: Optional[str] = ..., repo_type: Optional[str] = ..., pull_request: bool = ...) -> DiscussionWithDetails:
    ...
    @validate_hf_hub_args
    def create_pull_request(self, repo_id: str, title: str, *, token: Union[bool, str, None] = ..., description: Optional[str] = ..., repo_type: Optional[str] = ...) -> DiscussionWithDetails:
    ...
    @validate_hf_hub_args
    def comment_discussion(self, repo_id: str, discussion_num: int, comment: str, *, token: Union[bool, str, None] = ..., repo_type: Optional[str] = ...) -> DiscussionComment:
    ...
    @validate_hf_hub_args
    def rename_discussion(self, repo_id: str, discussion_num: int, new_title: str, *, token: Union[bool, str, None] = ..., repo_type: Optional[str] = ...) -> DiscussionTitleChange:
    ...
    @validate_hf_hub_args
    def change_discussion_status(self, repo_id: str, discussion_num: int, new_status: Literal["open", "closed"], *, token: Union[bool, str, None] = ..., comment: Optional[str] = ..., repo_type: Optional[str] = ...) -> DiscussionStatusChange:
    ...
    @validate_hf_hub_args
    def merge_pull_request(self, repo_id: str, discussion_num: int, *, token: Union[bool, str, None] = ..., comment: Optional[str] = ..., repo_type: Optional[str] = ...): # -> None:
    ...
    @validate_hf_hub_args
    def edit_discussion_comment(self, repo_id: str, discussion_num: int, comment_id: str, new_content: str, *, token: Union[bool, str, None] = ..., repo_type: Optional[str] = ...) -> DiscussionComment:
    ...
    @validate_hf_hub_args
    def hide_discussion_comment(self, repo_id: str, discussion_num: int, comment_id: str, *, token: Union[bool, str, None] = ..., repo_type: Optional[str] = ...) -> DiscussionComment:
    ...
    @validate_hf_hub_args
    def add_space_secret(self, repo_id: str, key: str, value: str, *, description: Optional[str] = ..., token: Union[bool, str, None] = ...) -> None:
    ...
    @validate_hf_hub_args
    def add_space_variable(self, repo_id: str, key: str, value: str, *, description: Optional[str] = ..., token: Union[bool, str, None] = ...) -> Dict[str, SpaceVariable]:
    ...
    @validate_hf_hub_args
    def delete_space_variable(self, repo_id: str, key: str, *, token: Union[bool, str, None] = ...) -> Dict[str, SpaceVariable]:
    ...
    @validate_hf_hub_args
    def request_space_hardware(self, repo_id: str, hardware: SpaceHardware, *, token: Union[bool, str, None] = ..., sleep_time: Optional[int] = ...) -> SpaceRuntime:
    ...
    @validate_hf_hub_args
    def set_space_sleep_time(self, repo_id: str, sleep_time: int, *, token: Union[bool, str, None] = ...) -> SpaceRuntime:
    ...
    @validate_hf_hub_args
    def restart_space(self, repo_id: str, *, token: Union[bool, str, None] = ..., factory_reboot: bool = ...) -> SpaceRuntime:
        """Restart your Space.
    ...
    @validate_hf_hub_args
    def duplicate_space(self, from_id: str, to_id: Optional[str] = ..., *, private: Optional[bool] = ..., token: Union[bool, str, None] = ..., exist_ok: bool = ..., hardware: Optional[SpaceHardware] = ..., storage: Optional[SpaceStorage] = ..., sleep_time: Optional[int] = ..., secrets: Optional[List[Dict[str, str]]] = ..., variables: Optional[List[Dict[str, str]]] = ...) -> RepoUrl:
        """Duplicate a Space.
    ...
    @validate_hf_hub_args
    def request_space_storage(self, repo_id: str, storage: SpaceStorage, *, token: Union[bool, str, None] = ...) -> SpaceRuntime:
    ...
    def list_inference_endpoints(self, namespace: Optional[str] = ..., *, token: Union[bool, str, None] = ...) -> List[InferenceEndpoint]:
    ...
    def create_inference_endpoint(self, name: str, *, repository: str, framework: str, accelerator: str, instance_size: str, instance_type: str, region: str, vendor: str, account_id: Optional[str] = ..., min_replica: int = ..., max_replica: int = ..., scale_to_zero_timeout: Optional[int] = ..., revision: Optional[str] = ..., task: Optional[str] = ..., custom_image: Optional[Dict] = ..., env: Optional[Dict[str, str]] = ..., secrets: Optional[Dict[str, str]] = ..., type: InferenceEndpointType = ..., domain: Optional[str] = ..., path: Optional[str] = ..., cache_http_responses: Optional[bool] = ..., tags: Optional[List[str]] = ..., namespace: Optional[str] = ..., token: Union[bool, str, None] = ...) -> InferenceEndpoint:
    ...
    @experimental
    @validate_hf_hub_args
    def create_inference_endpoint_from_catalog(self, repo_id: str, *, name: Optional[str] = ..., token: Union[bool, str, None] = ..., namespace: Optional[str] = ...) -> InferenceEndpoint:
    ...
    def get_inference_endpoint(self, name: str, *, namespace: Optional[str] = ..., token: Union[bool, str, None] = ...) -> InferenceEndpoint:
    ...
    def update_inference_endpoint(self, name: str, *, accelerator: Optional[str] = ..., instance_size: Optional[str] = ..., instance_type: Optional[str] = ..., min_replica: Optional[int] = ..., max_replica: Optional[int] = ..., scale_to_zero_timeout: Optional[int] = ..., repository: Optional[str] = ..., framework: Optional[str] = ..., revision: Optional[str] = ..., task: Optional[str] = ..., custom_image: Optional[Dict] = ..., env: Optional[Dict[str, str]] = ..., secrets: Optional[Dict[str, str]] = ..., domain: Optional[str] = ..., path: Optional[str] = ..., cache_http_responses: Optional[bool] = ..., tags: Optional[List[str]] = ..., namespace: Optional[str] = ..., token: Union[bool, str, None] = ...) -> InferenceEndpoint:
    ...
    def delete_inference_endpoint(self, name: str, *, namespace: Optional[str] = ..., token: Union[bool, str, None] = ...) -> None:
    ...
    def pause_inference_endpoint(self, name: str, *, namespace: Optional[str] = ..., token: Union[bool, str, None] = ...) -> InferenceEndpoint:
    ...
    def resume_inference_endpoint(self, name: str, *, namespace: Optional[str] = ..., running_ok: bool = ..., token: Union[bool, str, None] = ...) -> InferenceEndpoint:
    ...
    def scale_to_zero_inference_endpoint(self, name: str, *, namespace: Optional[str] = ..., token: Union[bool, str, None] = ...) -> InferenceEndpoint:
    ...
    @validate_hf_hub_args
    def list_collections(self, *, owner: Union[List[str], str, None] = ..., item: Union[List[str], str, None] = ..., sort: Optional[Literal["lastModified", "trending", "upvotes"]] = ..., limit: Optional[int] = ..., token: Union[bool, str, None] = ...) -> Iterable[Collection]:
    ...
    def create_collection(self, title: str, *, namespace: Optional[str] = ..., description: Optional[str] = ..., private: bool = ..., exists_ok: bool = ..., token: Union[bool, str, None] = ...) -> Collection:
    ...
    def update_collection_metadata(self, collection_slug: str, *, title: Optional[str] = ..., description: Optional[str] = ..., position: Optional[int] = ..., private: Optional[bool] = ..., theme: Optional[str] = ..., token: Union[bool, str, None] = ...) -> Collection:
    ...
    def delete_collection(self, collection_slug: str, *, missing_ok: bool = ..., token: Union[bool, str, None] = ...) -> None:
    ...
    def add_collection_item(self, collection_slug: str, item_id: str, item_type: CollectionItemType_T, *, note: Optional[str] = ..., exists_ok: bool = ..., token: Union[bool, str, None] = ...) -> Collection:
    ...
    def update_collection_item(self, collection_slug: str, item_object_id: str, *, note: Optional[str] = ..., position: Optional[int] = ..., token: Union[bool, str, None] = ...) -> None:
    ...
    def delete_collection_item(self, collection_slug: str, item_object_id: str, *, missing_ok: bool = ..., token: Union[bool, str, None] = ...) -> None:
    ...
    @validate_hf_hub_args
    def list_pending_access_requests(self, repo_id: str, *, repo_type: Optional[str] = ..., token: Union[bool, str, None] = ...) -> List[AccessRequest]:
        """
    ...
    @validate_hf_hub_args
    def list_accepted_access_requests(self, repo_id: str, *, repo_type: Optional[str] = ..., token: Union[bool, str, None] = ...) -> List[AccessRequest]:
        """
    ...
    @validate_hf_hub_args
    def list_rejected_access_requests(self, repo_id: str, *, repo_type: Optional[str] = ..., token: Union[bool, str, None] = ...) -> List[AccessRequest]:
        """
    ...
    @validate_hf_hub_args
    def cancel_access_request(self, repo_id: str, user: str, *, repo_type: Optional[str] = ..., token: Union[bool, str, None] = ...) -> None:
        """
    ...
    @validate_hf_hub_args
    def accept_access_request(self, repo_id: str, user: str, *, repo_type: Optional[str] = ..., token: Union[bool, str, None] = ...) -> None:
        """
    ...
    @validate_hf_hub_args
    def reject_access_request(self, repo_id: str, user: str, *, repo_type: Optional[str] = ..., rejection_reason: Optional[str], token: Union[bool, str, None] = ...) -> None:
        """
    ...
    @validate_hf_hub_args
    def grant_access(self, repo_id: str, user: str, *, repo_type: Optional[str] = ..., token: Union[bool, str, None] = ...) -> None:
        """
    ...
    @validate_hf_hub_args
    def create_webhook(self, *, url: Optional[str] = ..., job_id: Optional[str] = ..., watched: List[Union[Dict, WebhookWatchedItem]], domains: Optional[List[constants.WEBHOOK_DOMAIN_T]] = ..., secret: Optional[str] = ..., token: Union[bool, str, None] = ...) -> WebhookInfo:
    ...
    @validate_hf_hub_args
    def update_webhook(self, webhook_id: str, *, url: Optional[str] = ..., watched: Optional[List[Union[Dict, WebhookWatchedItem]]] = ..., domains: Optional[List[constants.WEBHOOK_DOMAIN_T]] = ..., secret: Optional[str] = ..., token: Union[bool, str, None] = ...) -> WebhookInfo:
    ...
    def run_job(self, *, image: str, command: List[str], env: Optional[Dict[str, Any]] = ..., secrets: Optional[Dict[str, Any]] = ..., flavor: Optional[SpaceHardware] = ..., timeout: Optional[Union[int, float, str]] = ..., namespace: Optional[str] = ..., token: Union[bool, str, None] = ...) -> JobInfo:
        """
    ...
    def fetch_job_logs(self, *, job_id: str, namespace: Optional[str] = ..., token: Union[bool, str, None] = ...) -> Iterable[str]:
        """
    ...
    def list_jobs(self, *, timeout: Optional[int] = ..., namespace: Optional[str] = ..., token: Union[bool, str, None] = ...) -> List[JobInfo]:
        """
    ...
    def inspect_job(self, *, job_id: str, namespace: Optional[str] = ..., token: Union[bool, str, None] = ...) -> JobInfo:
        """
    ...
    @experimental
    def run_uv_job(self, script: str, *, script_args: Optional[List[str]] = ..., dependencies: Optional[List[str]] = ..., python: Optional[str] = ..., image: Optional[str] = ..., env: Optional[Dict[str, Any]] = ..., secrets: Optional[Dict[str, Any]] = ..., flavor: Optional[SpaceHardware] = ..., timeout: Optional[Union[int, float, str]] = ..., namespace: Optional[str] = ..., token: Union[bool, str, None] = ..., _repo: Optional[str] = ...) -> JobInfo:
        """
    ...
    def create_scheduled_job(self, *, image: str, command: List[str], schedule: str, suspend: Optional[bool] = ..., concurrency: Optional[bool] = ..., env: Optional[Dict[str, Any]] = ..., secrets: Optional[Dict[str, Any]] = ..., flavor: Optional[SpaceHardware] = ..., timeout: Optional[Union[int, float, str]] = ..., namespace: Optional[str] = ..., token: Union[bool, str, None] = ...) -> ScheduledJobInfo:
        """
    ...
    def list_scheduled_jobs(self, *, timeout: Optional[int] = ..., namespace: Optional[str] = ..., token: Union[bool, str, None] = ...) -> List[ScheduledJobInfo]:
        """
    ...
    def inspect_scheduled_job(self, *, scheduled_job_id: str, namespace: Optional[str] = ..., token: Union[bool, str, None] = ...) -> ScheduledJobInfo:
        """
    ...
    def delete_scheduled_job(self, *, scheduled_job_id: str, namespace: Optional[str] = ..., token: Union[bool, str, None] = ...) -> None:
        """
    ...
    def suspend_scheduled_job(self, *, scheduled_job_id: str, namespace: Optional[str] = ..., token: Union[bool, str, None] = ...) -> None:
        """
    ...
    def resume_scheduled_job(self, *, scheduled_job_id: str, namespace: Optional[str] = ..., token: Union[bool, str, None] = ...) -> None:
        """
    ...
    @experimental
    def create_scheduled_uv_job(self, script: str, *, script_args: Optional[List[str]] = ..., schedule: str, suspend: Optional[bool] = ..., concurrency: Optional[bool] = ..., dependencies: Optional[List[str]] = ..., python: Optional[str] = ..., image: Optional[str] = ..., env: Optional[Dict[str, Any]] = ..., secrets: Optional[Dict[str, Any]] = ..., flavor: Optional[SpaceHardware] = ..., timeout: Optional[Union[int, float, str]] = ..., namespace: Optional[str] = ..., token: Union[bool, str, None] = ..., _repo: Optional[str] = ...) -> ScheduledJobInfo:
        """
        Run a UV script Job on Hugging Face infrastructure.
