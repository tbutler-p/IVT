...
class InferenceClient:
    ...
    def image_to_video(self, image: ContentT, *, model: Optional[str] = ..., prompt: Optional[str] = ..., negative_prompt: Optional[str] = ..., num_frames: Optional[float] = ..., num_inference_steps: Optional[int] = ..., guidance_scale: Optional[float] = ..., seed: Optional[int] = ..., target_size: Optional[ImageToVideoTargetSize] = ..., **kwargs) -> bytes:
        """
