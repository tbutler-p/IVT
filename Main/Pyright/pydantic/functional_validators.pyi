...
from typing import Annotated, Any, Callable, Literal, Protocol, TYPE_CHECKING, TypeVar, Union, overload
...
if TYPE_CHECKING:
    ...
    class _V2WrapValidatorClsMethod(Protocol):
        def __call__(self, cls: Any, value: Any, handler: core_schema.ValidatorFunctionWrapHandler, info: core_schema.ValidationInfo[Any], /) -> Any:
            ...
        
    
    
    _V2Validator = Union[_V2ValidatorClsMethod, core_schema.WithInfoValidatorFunction, _OnlyValueValidatorClsMethod, core_schema.NoInfoValidatorFunction,]
    _V2WrapValidator = Union[_V2WrapValidatorClsMethod, core_schema.WithInfoWrapValidatorFunction, _OnlyValueWrapValidatorClsMethod, core_schema.NoInfoWrapValidatorFunction,]
...
def field_validator(field: str, /, *fields: str, mode: FieldValidatorModes = ..., check_fields: bool | None = ..., json_schema_input_type: Any = ...) -> Callable[[Any], Any]:
    """!!! abstract "Usage Documentation"
...
class ModelWrapValidatorHandler(core_schema.ValidatorFunctionWrapHandler, Protocol[_ModelTypeCo]):
    ...
    def __call__(self, value: Any, outer_location: str | int | None = ..., /) -> _ModelTypeCo:
        ...
...
class ModelWrapValidator(Protocol[_ModelType]):
    ...
    def __call__(self, cls: type[_ModelType], value: Any, handler: ModelWrapValidatorHandler[_ModelType], info: core_schema.ValidationInfo, /) -> _ModelType:
        ...
...
class FreeModelBeforeValidator(Protocol):
    ...
    def __call__(self, value: Any, info: core_schema.ValidationInfo[Any], /) -> Any:
        ...
