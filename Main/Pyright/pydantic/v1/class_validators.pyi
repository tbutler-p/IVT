...
from pydantic.v1.typing import AnyCallable, AnyClassMethod
...
class Validator:
    __slots__ = ...
    def __init__(self, func: AnyCallable, pre: bool = ..., each_item: bool = ..., always: bool = ..., check_fields: bool = ..., skip_on_failure: bool = ...) -> None:
        ...
...
def validator(*fields: str, pre: bool = ..., each_item: bool = ..., always: bool = ..., check_fields: bool = ..., whole: Optional[bool] = ..., allow_reuse: bool = ...) -> Callable[[AnyCallable], AnyClassMethod]:
    """
...
@overload
def root_validator(*, pre: bool = ..., allow_reuse: bool = ..., skip_on_failure: bool = ...) -> Callable[[AnyCallable], AnyClassMethod]:
    ...

def root_validator(_func: Optional[AnyCallable] = ..., *, pre: bool = ..., allow_reuse: bool = ..., skip_on_failure: bool = ...) -> Union[AnyClassMethod, Callable[[AnyCallable], AnyClassMethod]]:
    """
