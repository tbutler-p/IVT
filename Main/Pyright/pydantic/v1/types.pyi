...
from typing import Any, Callable, ClassVar, Dict, FrozenSet, List, Optional, Pattern, Set, TYPE_CHECKING, Tuple, Type, TypeVar, Union
...
def conint(*, strict: bool = ..., gt: Optional[int] = ..., ge: Optional[int] = ..., lt: Optional[int] = ..., le: Optional[int] = ..., multiple_of: Optional[int] = ...) -> Type[int]:
    ...
...
def confloat(*, strict: bool = ..., gt: float = ..., ge: float = ..., lt: float = ..., le: float = ..., multiple_of: float = ..., allow_inf_nan: Optional[bool] = ...) -> Type[float]:
    ...
...
def conbytes(*, strip_whitespace: bool = ..., to_upper: bool = ..., to_lower: bool = ..., min_length: Optional[int] = ..., max_length: Optional[int] = ..., strict: bool = ...) -> Type[bytes]:
    ...
...
class ConstrainedStr(str):
    ...
    regex: Optional[Union[str, Pattern[str]]] = ...
    strict = ...
    @classmethod
    def __modify_schema__(cls, field_schema: Dict[str, Any]) -> None:
        ...
...
def constr(*, strip_whitespace: bool = ..., to_upper: bool = ..., to_lower: bool = ..., strict: bool = ..., min_length: Optional[int] = ..., max_length: Optional[int] = ..., curtail_length: Optional[int] = ..., regex: Optional[str] = ...) -> Type[str]:
    ...
...
def conset(item_type: Type[T], *, min_items: Optional[int] = ..., max_items: Optional[int] = ...) -> Type[Set[T]]:
    ...
...
def confrozenset(item_type: Type[T], *, min_items: Optional[int] = ..., max_items: Optional[int] = ...) -> Type[FrozenSet[T]]:
    ...
...
def conlist(item_type: Type[T], *, min_items: Optional[int] = ..., max_items: Optional[int] = ..., unique_items: bool = ...) -> Type[List[T]]:
    ...
...
def condecimal(*, gt: Decimal = ..., ge: Decimal = ..., lt: Decimal = ..., le: Decimal = ..., max_digits: Optional[int] = ..., decimal_places: Optional[int] = ..., multiple_of: Decimal = ...) -> Type[Decimal]:
    ...
...
def condate(*, gt: date = ..., ge: date = ..., lt: date = ..., le: date = ...) -> Type[date]:
    ...
