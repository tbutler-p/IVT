...
from typing import Any, Callable, Deque, Dict, FrozenSet, Generator, Hashable, List, NamedTuple, Pattern, Set, TYPE_CHECKING, Tuple, Type, TypeVar, Union
...
class IfConfig:
    def __init__(self, validator: AnyCallable, *config_attr_names: str, ignored_value: Any = ...) -> None:
        ...
