...
from typing import Any, Callable, Dict, Optional, Sequence, Set, TYPE_CHECKING, Tuple, Type, Union
...
def schema(models: Sequence[Union[Type[BaseModel], Type[Dataclass]]], *, by_alias: bool = ..., title: Optional[str] = ..., description: Optional[str] = ..., ref_prefix: Optional[str] = ..., ref_template: str = ...) -> Dict[str, Any]:
    """
...
def model_schema(model: Union[Type[BaseModel], Type[Dataclass]], by_alias: bool = ..., ref_prefix: Optional[str] = ..., ref_template: str = ...) -> Dict[str, Any]:
    """
...
def get_field_info_schema(field: ModelField, schema_overrides: bool = ...) -> Tuple[Dict[str, Any], bool]:
    ...

def field_schema(field: ModelField, *, by_alias: bool = ..., model_name_map: Dict[TypeModelOrEnum, str], ref_prefix: Optional[str] = ..., ref_template: str = ..., known_models: Optional[TypeModelSet] = ...) -> Tuple[Dict[str, Any], Dict[str, Any], Set[str]]:
    """
...
def get_flat_models_from_model(model: Type[BaseModel], known_models: Optional[TypeModelSet] = ...) -> TypeModelSet:
    """
...
def field_type_schema(field: ModelField, *, by_alias: bool, model_name_map: Dict[TypeModelOrEnum, str], ref_template: str, schema_overrides: bool = ..., ref_prefix: Optional[str] = ..., known_models: TypeModelSet) -> Tuple[Dict[str, Any], Dict[str, Any], Set[str]]:
    """
...
def model_process_schema(model: TypeModelOrEnum, *, by_alias: bool = ..., model_name_map: Dict[TypeModelOrEnum, str], ref_prefix: Optional[str] = ..., ref_template: str = ..., known_models: Optional[TypeModelSet] = ..., field: Optional[ModelField] = ...) -> Tuple[Dict[str, Any], Dict[str, Any], Set[str]]:
    """
...
def model_type_schema(model: Type[BaseModel], *, by_alias: bool, model_name_map: Dict[TypeModelOrEnum, str], ref_template: str, ref_prefix: Optional[str] = ..., known_models: TypeModelSet) -> Tuple[Dict[str, Any], Dict[str, Any], Set[str]]:
    """
...
def enum_process_schema(enum: Type[Enum], *, field: Optional[ModelField] = ...) -> Dict[str, Any]:
    """
...
def field_singleton_sub_fields_schema(field: ModelField, *, by_alias: bool, model_name_map: Dict[TypeModelOrEnum, str], ref_template: str, schema_overrides: bool = ..., ref_prefix: Optional[str] = ..., known_models: TypeModelSet) -> Tuple[Dict[str, Any], Dict[str, Any], Set[str]]:
    """
...
def field_singleton_schema(field: ModelField, *, by_alias: bool, model_name_map: Dict[TypeModelOrEnum, str], ref_template: str, schema_overrides: bool = ..., ref_prefix: Optional[str] = ..., known_models: TypeModelSet) -> Tuple[Dict[str, Any], Dict[str, Any], Set[str]]:
    """
...
def get_annotation_from_field_info(annotation: Any, field_info: FieldInfo, field_name: str, validate_assignment: bool = ...) -> Type[Any]:
    """
