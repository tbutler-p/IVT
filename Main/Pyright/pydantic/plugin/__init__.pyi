...
class ValidatePythonHandlerProtocol(BaseValidateHandlerProtocol, Protocol):
    ...
    def on_enter(self, input: Any, *, strict: bool | None = ..., extra: ExtraValues | None = ..., from_attributes: bool | None = ..., context: Any | None = ..., self_instance: Any | None = ..., by_alias: bool | None = ..., by_name: bool | None = ...) -> None:
...
class ValidateJsonHandlerProtocol(BaseValidateHandlerProtocol, Protocol):
    ...
    def on_enter(self, input: str | bytes | bytearray, *, strict: bool | None = ..., extra: ExtraValues | None = ..., context: Any | None = ..., self_instance: Any | None = ..., by_alias: bool | None = ..., by_name: bool | None = ...) -> None:
        """Callback to be notified of validation start, and create an instance of the event handler.
...
class ValidateStringsHandlerProtocol(BaseValidateHandlerProtocol, Protocol):
    ...
    def on_enter(self, input: StringInput, *, strict: bool | None = ..., extra: ExtraValues | None = ..., context: Any | None = ..., by_alias: bool | None = ..., by_name: bool | None = ...) -> None:
        """Callback to be notified of validation start, and create an instance of the event handler.
