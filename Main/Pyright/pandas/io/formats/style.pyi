...
from pandas._typing import Axis, AxisInt, FilePath, IndexLabel, IntervalClosedType, Level, QuantileInterpolation, Scalar, StorageOptions, WriteBuffer, WriteExcelBuffer
...
class Styler(StylerRenderer):
    ...
    *{"row": "MY_ROW_CLASS", "col_trim": "", "row_trim": ""}*.
    ...
    @Substitution(buf=buffering_args, encoding=encoding_args)
    def to_string(self, buf: FilePath | WriteBuffer[str] | None = ..., *, encoding: str | None = ..., sparse_index: bool | None = ..., sparse_columns: bool | None = ..., max_rows: int | None = ..., max_columns: int | None = ..., delimiter: str = ...) -> str | None:
        """
    ...
    def apply_index(self, func: Callable, axis: AxisInt | str = ..., level: Level | list[Level] | None = ..., **kwargs) -> Styler:
        """
    ...
    def map_index(self, func: Callable, axis: AxisInt | str = ..., level: Level | list[Level] | None = ..., **kwargs) -> Styler:
        ...
    
    def applymap_index(self, func: Callable, axis: AxisInt | str = ..., level: Level | list[Level] | None = ..., **kwargs) -> Styler:
        """
    ...
    def set_table_styles(self, table_styles: dict[Any, CSSStyles] | CSSStyles | None = ..., axis: AxisInt = ..., overwrite: bool = ..., css_class_names: dict[str, str] | None = ...) -> Styler:
        """
    ...
    @Substitution(subset=subset_args)
    def background_gradient(self, cmap: str | Colormap = ..., low: float = ..., high: float = ..., axis: Axis | None = ..., subset: Subset | None = ..., text_color_threshold: float = ..., vmin: float | None = ..., vmax: float | None = ..., gmap: Sequence | None = ...) -> Styler:
        """
    ...
    def text_gradient(self, cmap: str | Colormap = ..., low: float = ..., high: float = ..., axis: Axis | None = ..., subset: Subset | None = ..., vmin: float | None = ..., vmax: float | None = ..., gmap: Sequence | None = ...) -> Styler:
        ...
    ...
    @Substitution(subset=subset_args)
    def bar(self, subset: Subset | None = ..., axis: Axis | None = ..., *, color: str | list | tuple | None = ..., cmap: Any | None = ..., width: float = ..., height: float = ..., align: str | float | Callable = ..., vmin: float | None = ..., vmax: float | None = ..., props: str = ...) -> Styler:
        """
    ...
    @Substitution(subset=subset_args, color=coloring_args.format(default="yellow"), props=properties_args)
    def highlight_between(self, subset: Subset | None = ..., color: str = ..., axis: Axis | None = ..., left: Scalar | Sequence | None = ..., right: Scalar | Sequence | None = ..., inclusive: IntervalClosedType = ..., props: str | None = ...) -> Styler:
        """
    ...
    @Substitution(subset=subset_args, color=coloring_args.format(default="yellow"), props=properties_args)
    def highlight_quantile(self, subset: Subset | None = ..., color: str = ..., axis: Axis | None = ..., q_left: float = ..., q_right: float = ..., interpolation: QuantileInterpolation = ..., inclusive: IntervalClosedType = ..., props: str | None = ...) -> Styler:
        """
    ...
    @classmethod
    def from_custom_template(cls, searchpath: Sequence[str], html_table: str | None = ..., html_style: str | None = ...) -> type[Styler]:
        """
