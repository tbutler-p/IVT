...
class _Concatenator:
    ...
    """
    sort: bool
    def __init__(self, objs: Iterable[Series | DataFrame] | Mapping[HashableT, Series | DataFrame], axis: Axis = ..., join: str = ..., keys: Iterable[Hashable] | None = ..., levels=..., names: list[HashableT] | None = ..., ignore_index: bool = ..., verify_integrity: bool = ..., copy: bool = ..., sort: bool = ...) -> None:
        ...
