...
class ExponentialMovingWindow(BaseWindow):
    ...
    **times**
    ...
    @doc(template_header, create_section_header("Parameters"), dedent("""\
        ...
        """), kwargs_numeric_only, create_section_header("Returns"), template_returns, create_section_header("See Also"), template_see_also, create_section_header("Examples"), dedent("""\
        >>> ser = pd.Series([1, 2, 3, 4])
        >>> ser.ewm(alpha=.2).std()
        0         NaN
        1    0.707107
    ...
    def cov(self, other: DataFrame | Series | None = ..., pairwise: bool | None = ..., bias: bool = ..., numeric_only: bool = ...): # -> DataFrame | Series:
        ...
    ...
    def corr(self, other: DataFrame | Series | None = ..., pairwise: bool | None = ..., numeric_only: bool = ...): # -> DataFrame | Series:
        ...
